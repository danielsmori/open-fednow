...
| Dependency scanning — Dependabot + Trivy | ✅ Weekly Maven + Actions updates; Trivy scan fails the build on High/Critical severity, results also published to the repo's Security tab |
...
├── .github/workflows/        # CI (unit + integration) + Trivy vulnerability scan
├── LICENSE                   # Apache 2.0
└── README.md
```
...
- Dependabot + Trivy vulnerability-scan workflow; GitHub Actions CI with both unit and integration test jobs
